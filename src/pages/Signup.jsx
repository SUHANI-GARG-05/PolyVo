    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-brand-warm dark:bg-slate-900 px-4">
            ...
            >
                ...
                <h2 className="text-3xl font-bold text-center text-slate-900 dark:text-white mb-2">Get Started</h2>
                <p className="text-center text-slate-500 dark:text-slate-400 mb-8">Create your free account today</p>
